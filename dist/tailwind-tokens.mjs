 ...
 *   - fontWeight.medium (500) — matches Tailwind default
 *   - fontWeight.semibold (600) — matches Tailwind default
 *   - fontWeight.bold (700) — matches Tailwind default
 *   - borderRadius.none (0px) — matches Tailwind default
 *   - borderRadius.sm (0.125rem) — matches Tailwind default
 *   - borderRadius.md (0.375rem) — matches Tailwind default
 *   - borderRadius.lg (0.5rem) — matches Tailwind default
 */
